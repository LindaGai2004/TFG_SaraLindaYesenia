...
export default function DashboardJefe({
  ...
  function renderPopup() {
    ...
    if (type === 'trabajadores-popup') {
      return (
        <Modal open width="max-w-4xl" onClose={() => setPopup(null)} title="Trabajadores">
  ...
  return (
    <div>
      ...
      <div className="dashboard-cards">
        ...
        {/* Trabajadores — 替换了Total */}
        <div className="stat-card total" onClick={() => setPopup({ type: 'trabajadores-popup' })}>
          <div className="stat-card-header">
            <span className="stat-card-label green">Trabajadores</span>
        ...
        {/* Clientes */}
        <div className="stat-card white" onClick={() => setPopup({ type: 'clients-popup' })}>
          <div className="stat-card-header">
      ...
      {/* ── Productos más vendidos (sin gráfico) ── */}
