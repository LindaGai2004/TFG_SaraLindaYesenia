                                    ...
                                    <div key={idParaAccion} className="cart-item">
                                        ...
                                        <div className="cart-controls-group">
                                            <div className="cart-quantity-controls">
                                                <button onClick={() => decreaseCantidad(idParaAccion)} disabled={item.cantidad <= 1}>−</button>
                                                <span>{item.cantidad}</span>
                                                <button onClick={() => increaseCantidad(idParaAccion)}>+</button>
                                            </div>
                                            <button className="cart-btn-remove" onClick={() => quitarFromCart(idParaAccion)}>
                                                <img src="/eliminar_blanco.png" alt="Eliminar" style={{ width: 18, height: 18, objectFit: 'contain' }} />
                                            </button>
                                        </div>
